...
(
	...
	[active]        		char(1) NULL ,
	[description_spanish]   	varchar(300) NULL ,
	[description_french]    	varchar(300) NULL ,
	[description_italian]   	varchar(300) NULL ,
	[description_russian]   	varchar(300) NULL , 
	 PRIMARY KEY ([term_id])
)
;
GO
...
(
	...
	[action_time]   		time NULL DEFAULT (CONVERT(time(0), SYSDATETIME())) ,
...
(
	...
	[foreign_version]       	varchar(500) NULL ,
...
(
	...
	[dberror_no]    		int NULL ,
	[dberror_text]  		varchar(2000) NULL ,
	[additional_text]       	varchar(256) NULL ,
...
(
	...
	[c_end] 			char(1) NULL ,
	[rough_estimate]        	char(1) NULL ,
	[carton_types]  		varchar(300) NULL ,
	[carton_weights]        	varchar(400) NULL ,
...
(
	...
	[repair_comments]       	varchar(300) NULL ,
...
(
	...
	[time_in]       		time NOT NULL DEFAULT (CONVERT(time(0), SYSDATETIME())) ,
...
(
	...
	[error_time]    		time NULL DEFAULT (CONVERT(time(0), SYSDATETIME())) , 
	 PRIMARY KEY ([counter])
)
;
GO
...
(
	...
	[last_modified_date]    	datetime2(0) NULL DEFAULT (SYSDATETIME()) ,
	[spanish_questions]     	varchar(500) NULL ,
	[active]        		char(1) NULL ,
	[bd_type]       		char(50) NULL ,
	[french_questions]      	varchar(500) NULL ,
	[italian_questions]     	varchar(500) NULL ,
	[russian_questions]     	varchar(500) NULL ,
	[markable]      		char(5) NULL , 
...
(
	...
	[fax_man_id]    		int NULL ,
	[document_name] 		varchar(2500) NOT NULL ,
	[phone_no]      		char(50) NOT NULL ,
	[status]        		char(10) NULL ,
	[loc_code]      		char(5) NULL ,
	[loc_key]       		varchar(1000) NULL ,
	[document_desc] 		varchar(400) NULL ,
...
(
	...
	[document_name] 		varchar(2500) NULL ,
	[email_address] 		char(100) NULL ,
	[status]        		char(10) NULL ,
	[loc_code]      		char(5) NULL ,
	[loc_key]       		varchar(1000) NULL ,
	[document_description]  	varchar(400) NULL ,
	[modified_time] 		time NULL ,
	[modified_date] 		date NULL ,
	[dealer_code]   		char(10) NULL ,
...
(
	...
	[description_general]   	varchar(500) NULL ,
